            ...
            <div className='px-10 flex'>
                <div className=' py-32 space-y-3 w-1/2'>
                    ...
                    <div className='flex justify-between items-center py-4'>
                        <button className='py-2 px-7 text-3xl rounded-full font-bold border-blue-500 border-[3px] text-blue-500'>Get your own UPI</button>
                        <button className='py-2 px-7 text-3xl rounded-full font-bold border-blue-500 border-[3px] text-white bg-blue-500'>I'm a curious parent</button>
                    </div>
                </div>
